...
async def generate_comment(genres):
    ...
    # پرامپت جدید
    prompt = """
یک تحلیل کوتاه و جذاب به زبان فارسی درباره فیلم بنویس که نظر شخصی یک تماشاگر را منتقل کند. تحلیل باید به جنبه‌های مختلف فیلم (مانند داستان، شخصیت‌پردازی، کارگردانی، جنبه‌های بصری یا موسیقی) اشاره کند و نقاط قوت و ضعف احتمالی آن را نیز در نظر بگیرد. لحن باید صادقانه، کنجکاوانه و در عین حال جذاب باشد، به گونه‌ای که خواننده را به فکر وادار کند. از زبان ساده و روان استفاده کن. متن بین 50 تا 80 کلمه و شامل 4 تا 6 جمله کوتاه و کامل باشد و جمله آخر، یک جمع‌بندی کلی و واقع‌بینانه از تجربه تماشای فیلم ارائه دهد. از ذکر نام فیلم یا بازیگر و تشبیهات بسیار اغراق‌آمیز خودداری کن
"""
